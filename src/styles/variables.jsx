...
import { FaBuilding, FaBox, FaDollarSign } from "react-icons/fa";
import { TbReportAnalytics } from "react-icons/tb";
export const v = {
  iconoreportes: TbReportAnalytics,
  iconoempresa: FaBuilding,
  iconoproducto: FaBox,
  iconodinero: FaDollarSign,
  iconodescripcion: FaClipboardList,
  iconostockmin: FaExclamationCircle,
  iconocategoria: FaTags,
  iconoproveedor: FaIndustry,
  iconoestado: FaCheckCircle,
